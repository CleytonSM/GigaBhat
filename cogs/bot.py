...
async def lol(inter, player):
    ...
    await asyncio.sleep(5) # create a delay on the command to give it more time than 3 seconds (this is the least amount of time that Discord gives the bot to do something)
